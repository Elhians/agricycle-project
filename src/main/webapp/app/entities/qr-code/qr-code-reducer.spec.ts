...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './qr-code.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_QRCODE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_QRCODE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_QRCODE actions', async () => {
      const arg = { id: 8280 };
    ...
    it('dispatches UPDATE_QRCODE actions', async () => {
      const arg = { id: 8280 };
    ...
    it('dispatches PARTIAL_UPDATE_QRCODE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_QRCODE actions', async () => {
      const arg = 42666;
