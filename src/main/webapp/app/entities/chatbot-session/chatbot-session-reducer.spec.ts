...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CHATBOTSESSION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CHATBOTSESSION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CHATBOTSESSION actions', async () => {
      const arg = { id: 25418 };
    ...
    it('dispatches UPDATE_CHATBOTSESSION actions', async () => {
      const arg = { id: 25418 };
    ...
    it('dispatches PARTIAL_UPDATE_CHATBOTSESSION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CHATBOTSESSION actions', async () => {
      const arg = 42666;
