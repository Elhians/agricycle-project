...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SIGNALEMENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SIGNALEMENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SIGNALEMENT actions', async () => {
      const arg = { id: 19682 };
    ...
    it('dispatches UPDATE_SIGNALEMENT actions', async () => {
      const arg = { id: 19682 };
    ...
    it('dispatches PARTIAL_UPDATE_SIGNALEMENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SIGNALEMENT actions', async () => {
      const arg = 42666;
