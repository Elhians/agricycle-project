...
export const NotificationDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="agriCycleApp.notification.delete.question">
        <Translate contentKey="agriCycleApp.notification.delete.question" interpolate={{ id: notificationEntity.id }}>
