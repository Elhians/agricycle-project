...
export const TransactionDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="agriCycleApp.transaction.delete.question">
        <Translate contentKey="agriCycleApp.transaction.delete.question" interpolate={{ id: transactionEntity.id }}>
