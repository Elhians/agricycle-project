...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONTENUEDUCATIF_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CONTENUEDUCATIF actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CONTENUEDUCATIF actions', async () => {
      const arg = { id: 15650 };
    ...
    it('dispatches UPDATE_CONTENUEDUCATIF actions', async () => {
      const arg = { id: 15650 };
    ...
    it('dispatches PARTIAL_UPDATE_CONTENUEDUCATIF actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CONTENUEDUCATIF actions', async () => {
      const arg = 42666;
