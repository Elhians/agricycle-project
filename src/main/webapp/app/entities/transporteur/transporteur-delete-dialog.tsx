...
import { deleteEntity, getEntity } from './transporteur.reducer';
...
export const TransporteurDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="agriCycleApp.transporteur.delete.question">
        <Translate contentKey="agriCycleApp.transporteur.delete.question" interpolate={{ id: transporteurEntity.id }}>
