...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONSOMMATEUR_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CONSOMMATEUR actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CONSOMMATEUR actions', async () => {
      const arg = { id: 25602 };
    ...
    it('dispatches UPDATE_CONSOMMATEUR actions', async () => {
      const arg = { id: 25602 };
    ...
    it('dispatches PARTIAL_UPDATE_CONSOMMATEUR actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CONSOMMATEUR actions', async () => {
      const arg = 42666;
