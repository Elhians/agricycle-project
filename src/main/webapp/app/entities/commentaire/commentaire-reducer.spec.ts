...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMMENTAIRE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_COMMENTAIRE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_COMMENTAIRE actions', async () => {
      const arg = { id: 21726 };
    ...
    it('dispatches UPDATE_COMMENTAIRE actions', async () => {
      const arg = { id: 21726 };
    ...
    it('dispatches PARTIAL_UPDATE_COMMENTAIRE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_COMMENTAIRE actions', async () => {
      const arg = 42666;
