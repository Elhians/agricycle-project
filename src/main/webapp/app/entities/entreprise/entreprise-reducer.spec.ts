...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ENTREPRISE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ENTREPRISE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ENTREPRISE actions', async () => {
      const arg = { id: 5923 };
    ...
    it('dispatches UPDATE_ENTREPRISE actions', async () => {
      const arg = { id: 5923 };
    ...
    it('dispatches PARTIAL_UPDATE_ENTREPRISE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ENTREPRISE actions', async () => {
      const arg = 42666;
