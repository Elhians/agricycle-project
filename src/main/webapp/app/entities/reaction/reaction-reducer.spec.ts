...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './reaction.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REACTION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_REACTION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_REACTION actions', async () => {
      const arg = { id: 818 };
    ...
    it('dispatches UPDATE_REACTION actions', async () => {
      const arg = { id: 818 };
    ...
    it('dispatches PARTIAL_UPDATE_REACTION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_REACTION actions', async () => {
      const arg = 42666;
