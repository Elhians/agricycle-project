...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AGRICULTEUR_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_AGRICULTEUR actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_AGRICULTEUR actions', async () => {
      const arg = { id: 27847 };
    ...
    it('dispatches UPDATE_AGRICULTEUR actions', async () => {
      const arg = { id: 27847 };
    ...
    it('dispatches PARTIAL_UPDATE_AGRICULTEUR actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_AGRICULTEUR actions', async () => {
      const arg = 42666;
